...
export function Login() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // On success the browser navigates to Google — no navigate() call needed.
    // When Google redirects back, onAuthStateChange in AuthContext fires and
    // ProtectedLayout detects the session automatically.
  };
  ...
  return (
    <div className="min-h-screen bg-[#F4EFE8] flex items-center justify-center">
      <div className="bg-white rounded-2xl border border-gray-200 p-8 w-full max-w-md shadow-sm">
        ...
        <p className="text-gray-500 mb-8">Sign in to Reachly</p>
